...
if ready == "Y":
    ...
    q1 = str(input("What is your answwer? "))
    if q1 == answers[0]:
     ...
     q2 = str(input("What is your answer? "))
     if q2 == answers[1]:
        print("Correct! Adding £1000 to the bank!")
        bank = bank + 1000
        print("The next question is for £10000")
        print(questions[2])
        print("A Lemon, B Chocolate, C Clemintine, D Pineapple")
        q3 = str(input("What is your answer? "))
        if q3 == answers[2]:
           ...
           q4 = str(input("What is your answer? "))
           if q4 == answers[3]:
              ...
              q5 = str(input("What is your final answer? "))
              if q5 == answers[4]:
